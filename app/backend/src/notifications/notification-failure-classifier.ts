...
/**
 * Represents the persisted reason for a notification entering the dead-letter
 * state. The category is kept bounded for aggregation; the message preserves
 * the full raw error text for debugging.
 */
