...
export class OutboxController {
  ...
  async getDeadLetterDepth() {
    const depth = await this.notificationsService.getDeadLetterDepth();
  ...
  @ApiOkResponse({
    description: 'Replay initiated or no-op if not applicable.',
  })
  ...
  async replayDeadLetterBulk(@Body('ids') data: string[]) {
