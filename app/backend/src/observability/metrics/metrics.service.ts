...
export class MetricsService {
  ...
  constructor(
    ...
    @InjectMetric('app_notification_outbox_dead_letter_depth')
    public notificationOutboxDeadLetterDepthGauge: Gauge<string>,
  ...
  /**
   * Set the current depth of the notification outbox dead-letter queue.
   */
  setNotificationOutboxDeadLetterDepth(depth: number): void {
    this.notificationOutboxDeadLetterDepthGauge.set(depth);
  }
